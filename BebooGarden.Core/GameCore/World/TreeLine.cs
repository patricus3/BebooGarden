...
public class TreeLine
{
  ...
  public FruitSpecies? Shake()
  {
    ...
    GameHost.Current.SoundSystem.ShakeTrees();
    if (Fruits > 0 && GameHost.Current.Random.Next(6) == 5)
    {
      Fruits--;
      FruitSpecies droppedFruit = AvailableFruitSpecies[GameHost.Current.Random.Next(AvailableFruitSpecies.Count)];
      GameHost.Current.SoundSystem.DropFruitSound(droppedFruit);
      return droppedFruit;
    }
    else if (GameHost.Current.Random.Next(100) == 1)
    {
