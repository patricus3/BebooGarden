...
public class Map
{
  ...
  private void PopTicketPack()
  {
    if (!Items.OfType<TicketPack>().Any())
    {
      ...
      AddItem(new TicketPack(GameHost.Current.Random.Next(4)), randPos);
    }
  }
  ...
  public Vector3 GenerateRandomUnoccupedPosition(bool excludeWater = false, bool onlyWater = false)
  {
    ...
    do
    {
      randPos = new Vector3(GameHost.Current.Random.Next(-SizeX / 2, SizeX / 2), GameHost.Current.Random.Next(-SizeY / 2, SizeY / 2), 0);
      tryCounter++;
  ...
  public void Update()
  {
    ...
    {
     var SeaguleChannel=GameHost.Current.SoundSystem.System.PlaySound(GameHost.Current.SoundSystem.SeagullStream);
  ...
  public bool IsUnlocked()
  {
    return (Preset == MapPreset.garden)
      || (Preset == MapPreset.underwater && GameHost.Current.Save.Flags.UnlockUnderwaterMap)
      || (Preset == MapPreset.snowy && GameHost.Current.Save.Flags.UnlockSnowyMap)
      || (Preset == MapPreset.beach && GameHost.Current.Save.Flags.UnlockBeachMap)
      || (Preset == MapPreset.fluff && GameHost.Current.Save.Flags.UnlockFluffMap
      );
  }
