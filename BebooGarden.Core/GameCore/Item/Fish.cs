...
public class Fish : Item
{
  ...
  {
    GameHost.Current.SoundSystem.PlaySoundAtPosition(GameHost.Current.SoundSystem.FishFleeSound, Position.Value);
  }
  ...
  public override void Update()
  {
    ...
    {
      Channel channel = GameHost.Current.SoundSystem.PlaySoundAtPosition(GameHost.Current.SoundSystem.FishMoveSound, Position.Value);
    ...
    if (ChangeDestinationBehaviour.ItsTime())
    {
      ...
      Destination = GameHost.Current.Map.GenerateRandomUnoccupedPosition(onlyWater: true);
    ...
    if (MoveBehaviour.ItsTime())
    {
      ...
      if (GameHost.Current.Map.IsInWater(Position.Value + direction))
      {
